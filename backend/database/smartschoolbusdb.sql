...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 26, 2025 lúc 05:34 PM
...
(2, 'Trần Văn C', '2011-03-10', 'Lớp 7A', 'THCS Lê Lợi', 2, 1, 6, 6, 8),
(3, 'Hoàng Thị E', '2010-07-08', 'Lớp 8B', 'THCS Trần Hưng Đạo', 3, 1, 6, 5, 7),
(4, 'Võ Văn A', '2012-02-14', 'Lớp 6A', 'THCS Lý Thường Kiệt', 3, 1, 11, 1, 3);
